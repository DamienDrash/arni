...
-   **[ ] TASK-001: Fix `Contact.is_active` im Campaign Scheduler**
...
-   **[ ] TASK-002: Fix `evaluate_segment_v2` Aufruf im Scheduler**
...
-   **[ ] TASK-003: Fix `AdapterRegistry` Import und Aufruf**
...
-   **[ ] TASK-004: Refactor `send_campaign` Endpoint zur Nutzung des `MessageRenderer`**
...
-   **[ ] TASK-005: Fix Analytics API Endpoints & Frontend-Anbindung**
...
-   **[ ] TASK-006: Implementiere einen robusten `AnalyticsProcessor`**
...
-   **[ ] TASK-007: Vollständige Implementierung der A/B-Test-Logik**
...
-   **[ ] TASK-008: Füge Healthcheck zum `email-worker` hinzu**
