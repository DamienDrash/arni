...
SYSTEM_TOOLS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Query and manage ERP data: members, contracts, bookings, invoices.",
        "category": "erp",
    ...
    },
    {
        ...
        "description": "Generate platform-specific social media post text with hashtags.",
    ...
    },
    {
        ...
        "description": "Schedule social media posts for a future time.",
        "category": "social_media",
        "required_integration": "social_media",
        "min_plan_tier": "pro",
    },
    {
        ...
        "description": "Publish social media posts immediately.",
        "category": "social_media",
        "required_integration": "social_media",
        "min_plan_tier": "pro",
    },
...
SYSTEM_AGENTS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Compose, schedule, and publish social media posts across platforms.",
        "default_tools": json.dumps(["social_media_composer", "social_media_scheduler", "social_media_publisher", "knowledge_search"]),
        "max_turns": 5,
        "qa_profile": "standard",
        "min_plan_tier": "pro",
    },
