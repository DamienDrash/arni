...
async def get_permissions(
    ...
    if is_sys:
        ...
        pages_data = {
            ...
            "/infrastructure": True, "/llm-costs": True,
            "/revenue": True,
            "/settings/ai": True,
            "/campaigns": True,
            "/templates": True,
        ...
        if is_trial_expired:
            pages_data = {
                ...
                "/tenants": False,
                "/plans": False,
                "/infrastructure": False, "/llm-costs": False,
                "/revenue": False,
                "/settings/ai": False,
                "/campaigns": False,
                "/templates": False,
            ...
            "/campaign-analytics": True,
            "/planning": True,
            "/sync": features_data.get("api_access", False) or (plan and plan.slug not in ("starter", "trial")),
        }
