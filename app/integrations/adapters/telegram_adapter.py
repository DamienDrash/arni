...
class TelegramAdapter(BaseAdapter):
            ...
            "fields": [
                {
                    ...
                    "type": "password",
                    "required": True,
                    "help_text": "Telegram Bot Token von @BotFather.",
                },
            ],
        }
    ...
    async def get_contacts(
        ...
        return SyncResult(
            ...
            records_fetched=0,
            contacts=[],
            metadata={"note": "Telegram does not support contact sync."},
        )
    ...
    async def test_connection(self, config: dict) -> "ConnectionTestResult":
        ...
        return ConnectionTestResult(
            success=True,
            message="Telegram-Adapter geladen (Verbindungstest nicht implementiert).",
        )
