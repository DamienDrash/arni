...
DEFAULT_PROVIDERS = [
    {
        ...
        "supported_models": ["gpt-4o", "gpt-4o-mini", "gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "gpt-5-mini", "o3-mini", "o4-mini"],
...
DEFAULT_AGENTS = [
    ...
    {
        "slug": "concierge",
        "name": "Concierge & FAQ Agent",
        "description": "Handles general inquiries, FAQs, opening hours, location, and service information using the knowledge base.",
        "agent_class": "app.swarm.agents.persona.AgentPersona",
        "default_model": "gpt-4o-mini",
        "default_temperature": 0.5,
        "default_max_tokens": 600,
        "default_tools": ["knowledge_base"],
        "prompt_template_slug": "concierge/system",
    },
    {
        "slug": "booking",
        "name": "Booking & Scheduling Agent",
        "description": "Handles appointment booking, rescheduling, and cancellations via Calendly, Acuity, or CalCom.",
        "agent_class": "app.swarm.agents.ops.AgentOps",
        "default_model": "gpt-5-mini",
        "default_temperature": 0.3,
        "default_max_tokens": 800,
        "default_tools": ["calendly_booking"],
        "prompt_template_slug": "booking/system",
    },
    {
        "slug": "escalation",
        "name": "Escalation & Handoff Agent",
        "description": "Handles situations that require human intervention: complaints, legal issues, emotional distress.",
        "agent_class": "app.swarm.agents.persona.AgentPersona",
        "default_model": "gpt-4o-mini",
        "default_temperature": 0.4,
        "default_max_tokens": 500,
        "default_tools": ["member_memory"],
        "prompt_template_slug": "escalation/system",
    },
    {
        "slug": "vision",
...
def _seed_prompts(db: Session) -> None:
    ...
    template_files = {
        ...
        "concierge/system": ("Concierge & FAQ System Prompt", "concierge"),
        "booking/system": ("Booking & Scheduling System Prompt", "booking"),
        "escalation/system": ("Escalation & Handoff System Prompt", "escalation"),
    }
