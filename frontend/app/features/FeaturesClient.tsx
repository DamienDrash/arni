...
export default function FeaturesClient() {
  ...
  const coreFeatures = [
    {
      ...
      details: ["Intent-Erkennung", "Dynamisches Agent-Routing", "Fallback & Eskalation", "Confidence-Analyse"],
    },
    {
      icon: MessageSquare,
      ...
      color: "oklch(0.62 0.22 292)",
      details: ["WhatsApp Business API", "Telegram Polling", "Voice Pipeline", "Web-Chat"],
    },
    {
      icon: BarChart3,
      ...
      details: ["ML-basierte Prognose", "Proaktive Maßnahmen", "Risiko-Scoring", "Verhaltensanalyse"],
    },
    {
      icon: Cpu,
      ...
      details: ["Session Memory", "Semantic Memory", "Episodic Memory", "Automatische Extraktion"],
    },
    {
      icon: Lock,
      ...
      details: ["DSGVO-konform", "Row-Level Security", "PII-Filter", "Audit Logs"],
    },
    {
      icon: Plug,
      ...
      details: ["Magicline", "Shopify", "WooCommerce", "REST API"],
    },
  ];
  ...
  const platformFeatures = [
    { icon: Activity, title: "Live Monitor", desc: "Echtzeit-Übersicht aller aktiven Sessions." },
    { icon: BarChart3, title: "Churn Prediction", desc: "ML-basierte Vorhersage für gefährdete Kunden." },
    { icon: Users, title: "Mitgliederverwaltung", desc: "Kontaktdatenbank mit Churn-Score und Verträgen." },
    { icon: Layers, title: "Wissensbasis", desc: "WYSIWYG-Editor für deine Trainings-Inhalte." },
    { icon: Globe, title: "Multi-Tenant", desc: "Mehrere Standorte, ein zentrales Dashboard." },
    { icon: Sparkles, title: "Custom Prompts", desc: "Definiere Tonalität und Persona pro Tenant." },
  ];
