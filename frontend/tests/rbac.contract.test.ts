...
const cases: RoleCase[] = [
  {
    role: "system_admin",
    allowed: ["/", "/users", "/tenants", "/system-prompt", "/plans", "/audit", "/settings", "/settings/general", "/settings/account", "/swarm/agents", "/swarm/tools", "/swarm/orchestrators", "/swarm/agent-teams", "/campaigns/offers"],
