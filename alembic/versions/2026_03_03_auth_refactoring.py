...
def upgrade() -> None:
    ...
    # DSGVO consent
    op.add_column("tenants", sa.Column("tos_accepted_at", sa.DateTime(), nullable=True))
    op.add_column("tenants", sa.Column("privacy_accepted_at", sa.DateTime(), nullable=True))

    # Session configuration
    op.add_column("tenants", sa.Column("session_idle_timeout_minutes", sa.Integer(), server_default="30", nullable=False))
    op.add_column("tenants", sa.Column("session_absolute_timeout_hours", sa.Integer(), server_default="720", nullable=False))
